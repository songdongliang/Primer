package com.sdl.primer.ui.calendar;
...
//        canvas.drawRect(x + mPadding, y + mPadding, x + mItemWidth - mPadding, y + mItemHeight - mPadding, mSelectedPaint);
        ...
        } else if (endTime == 0 && beginTime < currentTime) {
            endTime = currentTime;
        } else if (beginTime > currentTime) {
            endTime = beginTime;
            beginTime = currentTime;
        } else if (endTime > currentTime && beginTime < currentTime) {
            endTime = currentTime;
        }
        canvas.drawCircle(x + mItemWidth / 2,y + mItemHeight / 2 ,mItemWidth / 2 - mPadding,mSelectedPaint);
